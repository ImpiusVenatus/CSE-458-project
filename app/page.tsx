...
export default function LandingPage() {
  ...
  const modules = [
    ...
    },
    {
      ...
      description:
        "Watch your piggy bank grow and see your savings tree bloom!",
      icon: "🐷",
    ...
    },
    {
      ...
      title: "Goal Setting",
      description:
        "Set savings goals and track your progress with fun visuals!",
      icon: "🎯",
  ...
  return (
    <div className="min-h-screen dark:bg-gray-900">
      ...
      <header className="bg-white dark:bg-gray-800 shadow-md sticky top-0 z-50 border-b border-gray-200 dark:border-gray-700">
        <div className="container mx-auto px-4 py-4 flex justify-between items-center">
          ...
          <nav className="flex items-center space-x-4">
            ...
            <Link
              href="/auth"
              className="btn-secondary dark:bg-gray-700 dark:text-gray-100 dark:border-gray-600"
            >
              Sign In
            </Link>
      ...
      <section className="container mx-auto px-4 py-16 text-center">
        ...
        >
          ...
          <p className="text-xl md:text-2xl text-gray-600 dark:text-gray-300 mb-8 max-w-2xl mx-auto">
            Learn about money through fun and interactive games designed just
            for kids!
          </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
          <div className="card text-center">
            ...
            <p className="text-gray-600 dark:text-gray-300">
              Learn through hands-on activities and fun games that make money
          ...
          <div className="card text-center">
            ...
            <p className="text-gray-600 dark:text-gray-300">
              Watch your savings grow with beautiful animations and see your
          ...
          <div className="card text-center">
            ...
            <p className="text-gray-600 dark:text-gray-300">
              Earn rewards and unlock achievements as you master new money
              skills!
            </p>
          </div>
        </div>
      ...
      <section
        id="modules"
        className="bg-white dark:bg-gray-800/50 py-16 border-t border-gray-200 dark:border-gray-700"
      >
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {modules.map((module, index) => (
              ...
              >
                <div
                  className={`w-16 h-16 rounded-full bg-gradient-to-r ${module.color} flex items-center justify-center text-3xl mb-4 mx-auto`}
                >
                  {module.icon}
                </div>
      ...
      <section className="container mx-auto px-4 py-16 text-center">
        <div className="bg-gradient-to-r from-primary-500 to-primary-600 rounded-3xl p-12 text-white">
          ...
          <p className="text-xl mb-8 opacity-90">
            Join thousands of kids learning about money in a fun and interactive
            way!
          </p>
          <Link
            href="/auth"
            className="bg-white text-primary-600 font-bold py-4 px-8 rounded-full shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-200 inline-block"
          >
            Get Started Free 🎉
          </Link>
        </div>
      ...
      <footer className="bg-gray-800 dark:bg-gray-900 text-white py-8 border-t border-gray-700">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-gray-400">
            Interactive Financial Learning for Kids | Computer Graphics Course
            Project
          </p>
